...
[![Course](https://img.shields.io/badge/Course-C526-1f6feb?style=for-the-badge)](https://www.tertiarycourses.com.sg/no-code-and-low-code-agentic-ai-applications.html)
...
[📘 Course Page](https://www.tertiarycourses.com.sg/no-code-and-low-code-agentic-ai-applications.html) · [📖 Step-by-Step Guide](LG-No%20Code%20and%20Low%20Code%20Agentic%20AI%20Applications%20%28C526%29.md) · [🐛 Report Bug](https://github.com/tertiarycourses/C526-No-Code-and-Low-Code-Agentic-AI-Applications/issues) · [💡 Request Feature](https://github.com/tertiarycourses/C526-No-Code-and-Low-Code-Agentic-AI-Applications/issues)
...
> ### 🎓 No Code and Low Code Agentic AI Applications
> **Course Code:** `C526` · 4 days / 30 hours · by Tertiary Courses / Tertiary Infotech
> **Course page:** https://www.tertiarycourses.com.sg/no-code-and-low-code-agentic-ai-applications.html
...
This repository contains the complete, working lab materials for the **No Code and Low Code Agentic AI Applications** course (**C526**) by Tertiary Courses / Tertiary Infotech. Each activity is a self-contained, importable [n8n](https://n8n.io) workflow — several paired with a polished HTML front end — building progressively over four days from basic automation to RAG, human-in-the-loop guardrails, real business use cases, and voice agents.
...
> 📖 **Full walkthrough:** see **[LG-No Code and Low Code Agentic AI Applications (C526).md](LG-No%20Code%20and%20Low%20Code%20Agentic%20AI%20Applications%20%28C526%29.md)** for detailed, click-by-click instructions (with workflow diagrams) for every activity. Slides, the Learner Guide and the Lesson Plan are in [`courseware/`](courseware/).
...
```
C526-No-Code-and-Low-Code-Agentic-AI-Applications/
├── LG-No Code and Low Code Agentic AI Applications (C526).md                  # Full step-by-step lab guide (start here)
├── README.md
...
### 1. Clone the repo
```bash
git clone https://github.com/tertiarycourses/C526-No-Code-and-Low-Code-Agentic-AI-Applications.git
cd C526-No-Code-and-Low-Code-Agentic-AI-Applications
```
...
For complete, click-by-click setup, see **[LG-No Code and Low Code Agentic AI Applications (C526).md](LG-No%20Code%20and%20Low%20Code%20Agentic%20AI%20Applications%20%28C526%29.md)**.
...
These materials are provided for **educational use** with the course *No Code and Low Code Agentic AI Applications* (C526) by Tertiary Courses / Tertiary Infotech Academy Pte Ltd.
