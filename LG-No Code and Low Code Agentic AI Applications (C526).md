...
*This guide follows the course learning outcomes across Topics 1–8.*
...
> **Note:** **GitHub repo:** https://github.com/tertiarycourses/C526-No-Code-and-Low-Code-Agentic-AI-Applications  ·  every activity lives under the **`labs/`** folder (one folder per activity), each with its workflow JSON, a workflow diagram, and any mock data.
...
Your capstone and the activities across the four days bring together the course learning outcomes: workflow design, AI agent / RAG integration, webhook & API use, human-in-the-loop and guardrails, business use cases, and voice agents.
