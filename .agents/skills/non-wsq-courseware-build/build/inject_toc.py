...
def main():
    ...
    # With Arial 10.5/11 pt, 3 pt paragraph spacing, the house margins and
    # footer, 40 entries is the reliable one-page limit. Using 44 caused a
    # 42-entry guide TOC to expand to two pages while every body reference
    # remained one page early.
    LINES_PER_PAGE = 40
